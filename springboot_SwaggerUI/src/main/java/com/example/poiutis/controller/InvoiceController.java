...
public class InvoiceController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "query", name="invoiceOrder1", value = "发票订单号集合", required = true ,dataType = "String")
    })
    @GetMapping(value = "/invoiceOrder/getInvoiceOrderDOCX")
...
//                                      @RequestParam(value="invoiceOrders") List<String>  invoiceOrders)  {
                                      @RequestParam(value="invoiceOrder1") String invoiceOrder1)  {

        Map<String, Object> map = new HashMap<>();

        List<String> invoiceOrders = new ArrayList<>();
        invoiceOrders.add("0001");
        invoiceOrders.add("0002");
        invoiceOrders.add("0003");
